...
SUMMARY_COLUMNS: dict[str, str] = {
    ...
    "workers": "Workers",
    "pipelines_found": "Pipelines Found",
...
def build_experiment_summary_row(
    ...
    return {
        ...
        SUMMARY_COLUMNS["validation_metric"]: result.get("validation_metric", ""),
        ...
        SUMMARY_COLUMNS["pipelines_found"]: result.get("pipelines_found", ""),
